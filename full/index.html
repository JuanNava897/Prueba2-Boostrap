			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Main -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Empleados</div> <i class="icon-menu" title="Empleados"></i></li>
						<li class="nav-item">
					...
					-->
                        ...
                        <li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu">
								...
								<li class="nav-item"><a href="datatable_basic.html" class="nav-link">Tabla de empleados</a></li>
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">agregar empleados</a></li>
								<li class="nav-item"><a href="form_actions.html" class="nav-link">Editar empleados</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu">
								...
								<li class="nav-item"><a href="datatable_basic.html" class="nav-link">Tabla de departamentos</a></li>
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">agregar departamentos</a></li>
								<li class="nav-item"><a href="form_actions.html" class="nav-link">Editar departamnetos</a></li>
							   <!-- <li class="nav-item"><a href="datatable_sorting.html" class="nav-link">Deptomb</a></li>
								<!-<li class="nav-item"><a href="datatable_api.html" class="nav-link">Using API</a></li>
								<li class="nav-item"><a href="datatable_data_sources.html" class="nav-link">Data sources</a></li>-->
							</ul>
					...
					<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu">
								...
								<li class="nav-item"><a href="datatable_basic.html" class="nav-link">Tabla de empresas</a></li>
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">Agregar empresas</a></li>
								<li class="nav-item"><a href="form_actions.html" class="nav-link">Editar empresas</a></li>
							   <!-- <li class="nav-item"><a href="datatable_sorting.html" class="nav-link">Deptomb</a></li>
								<!-<li class="nav-item"><a href="datatable_api.html" class="nav-link">Using API</a></li>
								<li class="nav-item"><a href="datatable_data_sources.html" class="nav-link">Data sources</a></li>-->
							</ul>
					...
					<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu">
								...
								<li class="nav-item"><a href="datatable_basic.html" class="nav-link">Tabla de vacaciones</a></li>
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">agregar vacaciones</a></li>
								<li class="nav-item"><a href="form_actions.html" class="nav-link">Editar vacaciones</a></li>
							   <!-- <li class="nav-item"><a href="datatable_sorting.html" class="nav-link">Deptomb</a></li>
								<!-<li class="nav-item"><a href="datatable_api.html" class="nav-link">Using API</a></li>
								<li class="nav-item"><a href="datatable_data_sources.html" class="nav-link">Data sources</a></li>-->
							</ul>
								...
								<table class="table text-nowrap">
									...
									<tbody>
										...
										<tr>
										 ...
										 lass="table-active table-border-double">
